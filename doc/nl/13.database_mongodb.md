...
Finch verbindt via een pool van `maxConnections` MongoDB-verbindingen (`Db.pool`) in plaats van één enkele verbinding, zodat gelijktijdige requests niet strijden om dezelfde socket.
