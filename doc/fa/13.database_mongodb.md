...
فینچ از طریق یک pool شامل `maxConnections` اتصال MongoDB (`Db.pool`) متصل می‌شود، نه یک اتصال تکی، بنابراین درخواست‌های هم‌زمان مجبور به رقابت بر سر یک سوکت مشترک نمی‌شوند.
